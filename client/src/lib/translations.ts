...
export const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    requestSubmittedDesc: 'سنتواصل معك قريباً لإعداد عرض مخصص لرحلتك',
  ...
  en: {
    ...
    requestSubmittedDesc: 'We will contact you soon to prepare a custom offer for your trip',
  ...
  fr: {
    ...
    requestSubmittedDesc: 'Nous vous contacterons bientôt pour préparer une offre personnalisée',
  ...
  es: {
    ...
    requestSubmittedDesc: 'Nos pondremos en contacto contigo pronto para preparar una oferta personalizada',
  ...
  tr: {
    ...
    requestSubmittedDesc: 'Geziniz için özel bir teklif hazırlamak üzere sizinle yakında iletişime geçeceğiz',
  ...
  zh: {
    ...
    requestSubmittedDesc: '我们将尽快与您联系，为您准备定制报价',
    selectCountry: '选择国家',
  ...
  ja: {
    ...
    requestSubmittedDesc: 'カスタムオファーを準備するために、近日中にご連絡いたします',
    selectCountry: '国を選択',
  ...
  fa: {
    ...
    requestSubmittedDesc: 'به زودی برای تهیه پیشنهاد سفارشی با شما تماس خواهیم گرفت',
