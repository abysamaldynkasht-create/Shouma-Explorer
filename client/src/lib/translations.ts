...
export const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    freeEntry: 'دخول مجاني لأصحاب الهمم',
  ...
  en: {
    ...
    freeEntry: 'Free Entry for People of Determination',
  ...
  fr: {
    ...
    freeEntry: 'Entrée gratuite pour les personnes déterminées',
  ...
  es: {
    ...
    freeEntry: 'Entrada gratuita para personas determinadas',
    ...
    selectGovernorate: 'Seleccione el gobernado',
  ...
  tr: {
    ...
    freeEntry: 'Engelli bireyler için ücretsiz giriş',
    ...
    selectGovernorate: 'Valiliği seçin',
  ...
  fa: {
    ...
    freeEntry: 'ورود رایگان برای افراد با اراده',
